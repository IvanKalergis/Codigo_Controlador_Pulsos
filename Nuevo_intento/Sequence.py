...
class Sequence: 
    def __init__(self, iteration_range, pb_pulses, pulses):

        self.iteration_range=[] # when is this sequence runned
        self.pb_pulses=[] # this is the list of the pulses sent to the pulse blaster (accounting for delays)
