...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Sequence_Creation.setGeometry(QRect(200, 20, 1151, 711))
        ...
        self.Define_Pulse.setGeometry(QRect(640, 320, 451, 371))
        self.verticalLayoutWidget = QWidget(self.Define_Pulse)
        self.verticalLayoutWidget.setObjectName(u"verticalLayoutWidget")
        self.verticalLayoutWidget.setGeometry(QRect(0, 30, 441, 331))
        ...
        self.real_width = QLabel(self.verticalLayoutWidget)
        self.real_width.setObjectName(u"real_width")

        self.horizontalLayout_2.addWidget(self.real_width)
        ...
        self.Add_Change.setMaximumSize(QSize(101, 32))

        self.horizontalLayout_17.addWidget(self.Add_Change)
    ...
    def retranslateUi(self, Form):
        ...
        self.real_width.setText(QCoreApplication.translate("Form", u"Real width: (       )", None))
